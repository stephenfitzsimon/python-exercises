...
#user_in = input("Enter a day of the week: ")
...
def get_input_2b():
    while True:
        user_in = input("Choose a multiplication table: ")
...
def get_input_2c():
    while True:
        user_in = input("Enter an odd number between 1 and 50: ")
...
def get_input_4():
    while True:
        user_in = input("What number would you like to go up to? ")
        if user_in.isnumeric() and int(user_in) > 0:
...
def get_input_5():
    while True:
        user_in = input("Enter a valid grade (1-100): ")
...
def get_input_6(b_dictionary):
    ...
    while True:
        print(f"Valid genres are: {valid_genre}")
